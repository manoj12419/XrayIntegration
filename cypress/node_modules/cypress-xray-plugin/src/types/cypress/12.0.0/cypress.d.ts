...
interface Cypress {
    ...
    Commands: {
        ...
        addAll<S = unknown>(options: CommandOptions & {
            prevSubject: true;
...
interface Chainable<Subject = unknown> {
    ...
    invoke<T extends (...args: unknown[]) => unknown>(options: Partial<Loggable & Timeoutable>, index: number): Chainable<ReturnType<T>>;
    ...
    request<T = unknown>(method: HttpMethod, url: string, body?: RequestBody): Chainable<CypressResponse<T>>;
