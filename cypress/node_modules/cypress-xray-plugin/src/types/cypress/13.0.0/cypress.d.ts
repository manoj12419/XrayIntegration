...
interface QueryFnWithOriginalFn<T extends keyof Chainable> {
    (this: Command, originalFn: QueryFn<T>, ...args: Parameters<ChainableMethods[T]>): (subject: unknown) => unknown;
}
...
interface Cypress {
    ...
    Commands: {
        ...
        add<T extends keyof Chainable, S = unknown>(name: T, options: CommandOptions & {
            prevSubject: true;
        }, fn: CommandFnWithSubject<T, S>): void;
        add<T extends keyof Chainable, S extends PrevSubject>(name: T, options: CommandOptions & {
            prevSubject: S | ["optional"];
        }, fn: CommandFnWithSubject<T, PrevSubjectMap[S]>): void;
        add<T extends keyof Chainable, S extends PrevSubject>(name: T, options: CommandOptions & {
            prevSubject: S[];
        }, fn: CommandFnWithSubject<T, PrevSubjectMap<void>[S]>): void;
        addAll<T extends keyof Chainable>(fns: CommandFns): void;
        addAll<T extends keyof Chainable>(options: CommandOptions & {
            prevSubject: false;
        }, fns: CommandFns): void;
        addAll<T extends keyof Chainable, S = unknown>(options: CommandOptions & {
            prevSubject: true;
        }, fns: CommandFnsWithSubject<S>): void;
        addAll<T extends keyof Chainable, S extends PrevSubject>(options: CommandOptions & {
            prevSubject: S | ["optional"];
...
interface Chainable<Subject = unknown> {
    ...
    fixture<Contents = unknown>(path: string, encoding: Encodings, options?: Partial<Timeoutable>): Chainable<Contents>;
    ...
    get<S = unknown>(alias: string, options?: Partial<Loggable & Timeoutable & Withinable & Shadow>): Chainable<S>;
    ...
    invoke<K extends keyof Subject, F extends ((...args: unknown[]) => unknown) & Subject[K], R = ReturnType<F>>(functionName: K, ...args: unknown[]): Chainable<R>;
    invoke<K extends keyof Subject, F extends ((...args: unknown[]) => unknown) & Subject[K], R = ReturnType<F>>(options: Partial<Loggable & Timeoutable>, functionName: K, ...args: unknown[]): Chainable<R>;
    invoke<T extends (...args: unknown[]) => unknown, Subject extends T[]>(index: number): Chainable<ReturnType<T>>;
    invoke<T extends (...args: unknown[]) => unknown, Subject extends T[]>(options: Partial<Loggable & Timeoutable>, index: number): Chainable<ReturnType<T>>;
    ...
    readFile<Contents = unknown>(filePath: string, options?: Partial<Loggable & Timeoutable>): Chainable<Contents>;
    readFile<Contents = unknown>(filePath: string, encoding: Encodings, options?: Partial<Loggable & Timeoutable>): Chainable<Contents>;
    ...
    request<T = unknown>(method: HttpMethod, url: string, body?: RequestBody): Chainable<Response<T>>;
    ...
    spread<S extends object | unknown[] | string | number | boolean>(fn: (...args: unknown[]) => S): Chainable<S>;
    spread(fn: (...args: unknown[]) => void): Chainable<Subject>;
    task<S = unknown>(event: string, arg?: unknown, options?: Partial<Loggable & Timeoutable>): Chainable<S>;
    ...
    then<S extends unknown[] | object>(fn: (this: ObjectLike, currentSubject: Subject) => S): Chainable<S>;
    ...
    then<S extends object | unknown[] | string | number | boolean>(options: Partial<Timeoutable>, fn: (this: ObjectLike, currentSubject: Subject) => S): Chainable<S>;
...
type ChainableMethods<Subject = unknown> = {
    [P in keyof Chainable<Subject>]: Chainable<Subject>[P] extends (...args: unknown[]) => unknown ? Chainable<Subject>[P] : never;
};
...
type DevServerFn<ComponentDevServerOpts = unknown> = (cypressDevServerConfig: DevServerConfig, devServerConfig: ComponentDevServerOpts) => ResolvedDevServerConfig | Promise<ResolvedDevServerConfig>;
...
type UserConfigOptions<ComponentDevServerOpts = unknown> = Omit<ResolvedConfigOptions<ComponentDevServerOpts>, "baseUrl" | "excludeSpecPattern" | "supportFile" | "specPattern" | "indexHtmlFile">;
...
interface Chainer<Subject> {
    ...
    (chainer: "have.property" | "have.nested.property" | "have.own.property" | "have.a.property" | "have.deep.property" | "have.deep.own.property" | "have.deep.nested.property", property: string, value?: unknown): Chainable<Subject>;
    ...
    (chainer: "include" | "deep.include" | "nested.include" | "own.include" | "deep.own.include" | "deep.nested.include", value: unknown): Chainable<Subject>;
    (chainer: "include.members" | "include.ordered.members" | "include.deep.ordered.members", value: unknown[]): Chainable<Subject>;
    ...
    (chainer: "not.have.unknown.keys" | "not.include.unknown.keys", ...value: string[]): Chainable<Subject>;
    ...
    (chainer: "not.have.property" | "not.have.nested.property" | "not.have.own.property" | "not.have.a.property" | "not.have.deep.property" | "not.have.deep.own.property" | "not.have.deep.nested.property", property: string, value?: unknown): Chainable<Subject>;
    ...
    (chainer: "not.include" | "not.deep.include" | "not.nested.include" | "not.own.include" | "not.deep.own.include" | "not.deep.nested.include", value: unknown): Chainable<Subject>;
    (chainer: "not.include.members" | "not.include.ordered.members" | "not.include.deep.ordered.members", value: unknown[]): Chainable<Subject>;
    ...
    (chainer: "be.always.calledWithMatch" | "always.have.been.calledWithMatch", ...args: unknown[]): Chainable<Subject>;
    ...
    (chainer: "be.calledWithExactly" | "have.been.calledWithExactly", ...args: unknown[]): Chainable<Subject>;
    (chainer: "be.calledWithMatch" | "have.been.calledWithMatch", ...args: unknown[]): Chainable<Subject>;
    ...
    (chainer: "be.always.calledWith" | "always.have.been.calledWith", ...args: unknown[]): Chainable<Subject>;
    (chainer: "be.calledOnceWith" | "have.been.calledOnceWith", ...args: unknown[]): Chainable<Subject>;
    (chainer: "be.always.calledWithExactly" | "have.been.calledWithExactly", ...args: unknown[]): Chainable<Subject>;
    (chainer: "be.calledOnceWithExactly" | "have.been.calledOnceWithExactly", ...args: unknown[]): Chainable<Subject>;
    ...
    (chainer: "not.be.always.calledWithMatch" | "not.always.have.been.calledWithMatch", ...args: unknown[]): Chainable<Subject>;
    (chainer: "not.always.returned" | "not.have.always.returned", value: unknown): Chainable<Subject>;
    ...
    (chainer: "not.be.calledWithExactly" | "not.have.been.calledWithExactly", ...args: unknown[]): Chainable<Subject>;
    (chainer: "not.be.calledWithMatch" | "not.have.been.calledWithMatch", ...args: unknown[]): Chainable<Subject>;
    ...
    (chainer: "not.be.always.calledOn" | "not.always.have.been.calledOn", obj: unknown): Chainable<Subject>;
    (chainer: "not.be.calledWith" | "not.have.been.calledWith", ...args: unknown[]): Chainable<Subject>;
    (chainer: "not.be.always.calledWith" | "not.always.have.been.calledWith", ...args: unknown[]): Chainable<Subject>;
    (chainer: "not.be.calledOnceWith" | "not.have.been.calledOnceWith", ...args: unknown[]): Chainable<Subject>;
    (chainer: "not.be.always.calledWithExactly" | "not.have.been.calledWithExactly", ...args: unknown[]): Chainable<Subject>;
    (chainer: "not.be.calledOnceWithExactly" | "not.have.been.calledOnceWithExactly", ...args: unknown[]): Chainable<Subject>;
...
interface Actions {
     ...
     * ```
     */
    (action: "uncaught:exception", fn: (error: Error, runnable: Mocha.Runnable, promise?: Promise<unknown>) => false | void): Cypress;
    /**
    ...
    (action: "test:before:run:async", fn: (attributes: ObjectLike, test: Mocha.Test) => void | Promise<unknown>): Cypress;
