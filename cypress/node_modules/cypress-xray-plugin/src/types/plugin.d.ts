 ...
 * default/fallback values are used by the plugin.
 */
export type InternalXrayOptions = XrayOptions & Required<Pick<XrayOptions, "status" | "uploadResults" | "uploadScreenshots">>;
 ...
 * default/fallback values are used by the plugin.
 */
export type InternalCucumberOptions = CucumberOptions & Required<Pick<CucumberOptions, "featureFileExtension" | "downloadFeatures" | "uploadFeatures">> & {
    /**
